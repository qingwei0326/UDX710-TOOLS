...
<template>
  <div class="space-y-6">
    ...
    <!-- 系统状态 - 卡片网格 -->
    <div v-if="deviceType !== 'no-battery'" class="rounded-3xl bg-white/95 dark:bg-white/5 backdrop-blur-xl border border-slate-200/60 dark:border-white/10 p-6 shadow-xl shadow-slate-200/40 dark:shadow-black/20 hover:shadow-2xl hover:shadow-slate-300/50 dark:hover:shadow-black/30 transition-all duration-500">
      <div class="flex items-center space-x-3 mb-6">
