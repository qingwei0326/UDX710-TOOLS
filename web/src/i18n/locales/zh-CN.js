export default {
  ...
  settings: {
    ...
    deviceType: '设备类型',
    deviceTypeDesc: '选择是否有电池，隐藏不需要的功能',
    withBattery: '有电池',
    withoutBattery: '无电池',
    menuManage: '菜单管理',
    menuManageDesc: '点击切换显示/隐藏，设置页始终显示',
    inputToConfirm: '请输入',
    toConfirm: '以确认：',
  ...
  rathole: {
    ...
    // Sakura Frp 使用指南
    frpcGuideIntro: '什么是 Sakura Frp？',
    frpcGuideIntroDesc: 'Sakura Frp（樱花穿透）是一个免费的内网穿透服务，无需自建服务器，即可将内网服务暴露到公网。',
    frpcGuideAdvantage: '免费使用，无需服务器，注册即可用。适合个人用户远程访问家庭设备。',
    frpcGuideStep1: '注册账号',
    frpcGuideStep1a: '访问 xfrp.net 注册账号',
    frpcGuideStep1b: '完成邮箱验证',
    frpcGuideStep1c: '登录控制面板',
    frpcGuideStep2: '获取 Access Token',
    frpcGuideStep2a: '登录后点击右上角头像',
    frpcGuideStep2b: '选择「API 密钥」或「Access Token」',
    frpcGuideStep2c: '复制 Token 粘贴到本页面',
    frpcGuideStep2Note: '也可以通过 API 获取：',
    frpcGuideStep3: '配置隧道',
    frpcGuideStep3a: '在本页面填写 Token',
    frpcGuideStep3b: '点击「添加隧道」',
    frpcGuideStep3c: '选择协议类型（TCP/UDP）',
    frpcGuideStep3d: '填写本地端口和远端端口',
    frpcGuideStep4: '启动连接',
    frpcGuideStep4Desc: '点击「启动」按钮，状态显示「运行中」即表示穿透成功。通过分配的公网地址即可访问内网服务。',
    frpcGuideWarning: '注意事项',
